...
1. [General assumptions](#general-assumptions)
    ...
    1. [Events](#events)
    1. [ArchUnit](#archunit)
    1. [Functional thinking](#functional-thinking)
    1. [No ORM](#no-orm)
    1. [Architecture-code gap](#architecture-code-gap)
    1. [Model-code gap](#model-code-gap)
    1. [Spring](#spring)
    1. [Tests](#tests)
